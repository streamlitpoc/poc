...
image = Image.open('Koch_logo.jpg')
image2 = Image.open('Molex_logo.png')


col1, col2= st.columns(2)
with col1:
    st.image(image,caption='Koch',use_column_width='always') 

with col2:
    st.image(image2,caption='Molex',use_column_width='always')

for i in range(7):
    st.text(" ")

st.write("Company Sales Summary:")
